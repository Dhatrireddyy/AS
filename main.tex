    ...
    \begin{frame}{Hypothesis testing}
        \begin{block}{\textbf{Case 2 continued}}
            Information:
             ...
             Using the rejection region approach, we reject $H_0$ if $t_{0.05,86}\geq t$ where $t_{0.05,86} = 1.6628$. We have enough statistical evidence to reject null hypothesis since $t^*$ is lesser than 1.6628. 
        \end{block}
    \end{frame}
